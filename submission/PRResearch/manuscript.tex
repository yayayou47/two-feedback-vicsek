\documentclass[aps,prresearch,preprint,amsmath,amssymb,nofootinbib,superscriptaddress]{revtex4-2}
% PRResearch (APS) house style. revtex4-2 + apsrev4-2.bst ship with TeX Live,
% so this compiles locally. If a revtex4-2 build rejects the `prresearch'
% journal option, use `pre' (sibling PR journal) or generic `aps'.
\usepackage{graphicx}
\usepackage{bm}
\usepackage{siunitx}
\usepackage{booktabs}
...
\email{yy.y@zig.univ.sn}
\affiliation{D\'epartement de Math\'ematiques, \'Ecole Normale Sup\'erieure de N'Djam\'ena, BP~206, N'Djam\'ena, Tchad}
\affiliation{Chercheur Associ\'e, LMA, U.F.R.~Sciences et Technologies, Universit\'e Assane Seck de Ziguinchor, BP~523, Diabir, Ziguinchor, S\'en\'egal}

\author{Mamadou Sy}
\email{mamadou.sy@ugb.edu.sn}
\affiliation{D\'epartement de Math\'ematiques et Informatique, Universit\'e Gaston-Berger de Saint-Louis, S\'en\'egal}
\affiliation{Laboratoire d'Analyse Num\'erique et Informatique, Universit\'e Gaston-Berger de Saint-Louis, S\'en\'egal}
