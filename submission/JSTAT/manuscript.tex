...
\usepackage{siunitx}
\usepackage{booktabs}
% JSTAT : « sequential numerical system […] the reference list
% lists the references in numerical order, not alphabetically ».
% [numbers] rend \citep en [1] ; unsrtnat ordonne par apparition.
...
\author{Yaya Youssouf Yaya \quad Mamadou Sy\thanks{D\'epartement de
        ...
        % Les affiliations sont dans un bloc de largeur contrainte : la
        % classe article centre le contenu de \author sans jamais le
        % couper, si bien qu'une adresse longue sort de la marge en
        % silence (c'etait le cas ici, 138 pt de debordement). Le
        % minipage force le retour a la ligne automatique.
        ...
        Chercheur Associ\'e, LMA, U.F.R.~Sciences et Technologies,
        Universit\'e Assane Seck de Ziguinchor, BP~523, Diabir,
        Ziguinchor, S\'en\'egal \\
        \texttt{yy.y@zig.univ.sn} \;\;
...
% JSTAT : « At the time of submission you must characterise your work
% with a number of keywords selected from the JSTAT keyword list.
% Please indicate these keywords after the abstract. »
% Les quatre retenus, et leur categorie, sont justifies dans
% submission_form/02_category_keywords.txt.
\medskip
\noindent\textbf{Keywords:} active matter, self-propelled particles,
classical phase transitions, finite-size scaling
...
% =====================================================================
%  Exigée par JSTAT : « Authors are required to declare and properly
%  reference in detail the use of AI assisted technology in the
%  preparation of the manuscript, either in the methods or
%  acknowledgments section. »
%
%  Outils déclarés : DeepL (DeepL SE) et ChatGPT (OpenAI), pour la
%  langue et la lisibilité uniquement.
%
%  FACULTATIF : si vous connaissez la version exacte du modèle ChatGPT
%  utilisé (GPT-4o, GPT-5, …), l'ajouter renforce le « in detail »
%  demandé par IOP. La déclaration est déjà soumissible sans elle.
% =====================================================================
DeepL (DeepL SE) and ChatGPT (OpenAI) were used for language editing,
to improve the wording and readability of the manuscript. The authors
reviewed and edited all output and take full responsibility for the
content of the published article. No text was generated without author
verification, and neither tool was used to design the study, to write
or modify the simulation and analysis code, or to produce, analyse or
interpret any data.
