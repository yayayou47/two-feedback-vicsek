...
% APS Open Science house style. revtex4-2 + apsrev4-2.bst ship with TeX Live,
% so this compiles locally. The generic `aps' journal option is used (REVTeX
% ships no dedicated APS Open Science option); add `pre' for the sibling PR
% format if a closer match is wanted.
\usepackage{graphicx}
\usepackage{bm}
\usepackage{siunitx}
\usepackage{booktabs}
